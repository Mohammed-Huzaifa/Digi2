...
const HigherEdRoles = [
  { title: "Academic Policy Assistant", desc: "Helps students and staff quickly understand academic policies, prerequisites, and deadlines.", icon: BookOpen },
  { title: "Study Skills Coach", desc: "Coaches students on time management, study strategies, and exam preparation.", icon: Clock },
  { title: "Course Insights Advisor", desc: "Surfaces course trends and helps students choose and balance their course selections.", icon: BarChart3 },
  { title: "Learning Resource Finder", desc: "Recommends relevant learning materials based on courses and challenges.", icon: Search },
  { title: "Campus Resource Navigator", desc: "Guides students to the right campus offices, services, and support programs.", icon: MapPin },
  { title: "Student Engagement Insights", desc: "Analyzes interaction patterns to highlight where engagement is dropping.", icon: Activity },
  { title: "Feedback Summarizer", desc: "Aggregates feedback into clear themes and action items for faculty.", icon: FileText },
  { title: "Career Readiness Coach", desc: "Supports students with resumes, interview practice, and career alignment.", icon: Briefcase },
  { title: "Academic Support Evaluator", desc: "Identifies which support interventions are working for which student groups.", icon: ClipboardCheck },
  { title: "Student Sentiment Pulse", desc: "Tracks sentiment across channels to give leadership a pulse on morale.", icon: Smile }
];
