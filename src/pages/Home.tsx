...
import { ArrowRight, MessageSquare, CheckCircle2, Zap, Layers, Users, ChevronRight, ChevronDown } from "lucide-react";
...
export default function Home() {
  ...
  {/* Desktop: keep in ONE line | Mobile: allow wrap */}
    ...
    {item.title}
      ...
      <section className="container py-24 glass-bg">
        <AnimatedSection className="text-center mb-16">
          <h2 className="text-5xl font-heading font-bold mb-4 tracking-tight">How It Works</h2>
          <p className="text-muted-foreground text-lg">Deploy AI coworkers from day one or orchestrate custom outcomes through a clear, structured
          3-step engagement model.</p>
        </AnimatedSection>
...
<section className="container py-10">
  ...
  key={i}
  delay={i * 0.05}
  className="glass-card rounded-lg p-6 transition-colors group"
>
  <button
    type="button"
