  ...
  return (
    <div className="w-full h-full text-[#f2f2f2] flex flex-col">
      ...
      <div className="py-6 md:flex-1 flex flex-col gap-6 md:gap-11 md:justify-center mb-6 md:mb-1 edge-to-edge relative">
        ...
        <div className="absolute top-0 left-0 bottom-0 w-8 bg-linear-to-r from-background to-transparent pointer-events-none z-10" />
        ...
        <div className="absolute top-0 right-0 bottom-0 w-8 bg-linear-to-l from-background to-transparent pointer-events-none z-10" />
      </div>
      
      {/* Bottom left content */}
      <div>
        <p className="font-body font-light text-sm text-[#6a6565] mb-2">
          Our AI Coworkers connect effortlessly to the tools that power your enterprise. They are designed for native integration with industry leaders in search, data, and models.
        </p>
        {/* <button 
